    ...
    <div class="min-h-screen bg-[#E5E5E3] font-sans antialiased pb-24">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-[#777777] font-medium text-sm lowercase mt-1">
                            update the global classification
                        </p>
                    </div>
                </div>
            </div>
        ...
        <main class="max-w-3xl mx-auto px-6 lg:px-8 mt-12 animate-fade-in-up">
            <div class="bg-white rounded-[2.5rem] shadow-sm overflow-hidden border border-gray-100 p-10 relative group">
                <div class="absolute -right-16 -top-16 w-48 h-48 bg-[#F4F4F4] rounded-full group-hover:scale-110 transition duration-1000 rotate-12"></div>
                
                <div class="relative z-10 text-center mb-12">
                    <div class="w-20 h-20 bg-[#F4F4F4] text-[#555555] rounded-[2rem] flex items-center justify-center mx-auto mb-6 shadow-sm border border-gray-50 group-hover:scale-105 transition-transform duration-500">
                ...
                <form action="{{ route('admin.ticket-types.update', $ticketType->id_ticket_type) }}" method="POST" id="edit-ticket-type-form" class="relative z-10">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-10">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $ticketType->name) }}" placeholder="e.g. VIP, Regular..." 
                        ...
                        <div class="pt-6">
                            <button type="button" onclick="confirmUpdate('edit-ticket-type-form')" class="w-full py-5 bg-[#555555] text-white rounded-[2rem] font-bold text-lg lowercase hover:bg-black transition-all shadow-lg active:scale-95 group">
                                update ticket type.
                            </button>
                        </div>
                    </div>
