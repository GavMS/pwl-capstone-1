                    ...
                    <div class="space-y-10">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="description" id="description" placeholder="describe the benefits of this ticket type..." rows="3"
                                class="w-full px-8 py-5 bg-[#F4F4F4] border-none rounded-2xl focus:ring-4 focus:ring-[#555555]/10 focus:bg-white transition-all text-[#444444] font-bold text-lg tracking-tight placeholder:text-[#999999]/50" required>{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-2 text-xs font-bold text-red-500 ml-1">{{ $message }}</p>
                            @enderror
                        </div>
