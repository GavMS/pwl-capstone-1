    ...
    <div class="nav-container">
        ...
        @if (Auth::check() && Auth::user()->role === 'admin')
            ...
            <a href="{{ route('admin.ticket-types.index') }}" class="nav-link {{ request()->routeIs('admin.ticket-types.*') ? 'active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 012-2h10a2 2 0 012 2v14a2 2 0 01-2 2H7a2 2 0 01-2-2V5z"></path></svg>
                ticket types
            </a>
            <a href="{{ route('admin.financials') }}" class="nav-link {{ request()->routeIs('admin.financials') ? 'active' : '' }}">
        ...
        @elseif (Auth::check() && Auth::user()->role === 'organizer')
            ...
            <a href="{{ route('organizer.events.index') }}" class="nav-link {{ request()->routeIs('organizer.events.index') ? 'active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                my events
            </a>
            <a href="{{ route('organizer.sales') }}" class="nav-link {{ request()->routeIs('organizer.sales') ? 'active' : '' }}">
            ...
            <a href="{{ route('organizer.scan') }}" class="nav-link {{ request()->routeIs('organizer.scan*') ? 'active' : '' }}">
        ...
        @elseif (Auth::check())
            ...
            <a href="{{ route('user.my-tickets') }}" class="nav-link {{ request()->routeIs('user.my-tickets') ? 'active' : '' }}">
