<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-50 w-72 bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-auto flex flex-col">
    ...
    <div class="flex-1 px-4 space-y-2 overflow-y-auto">
        ...
        @if (Auth::user()->role === 'admin')
            ...
            <a href="{{ route('admin.events.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-2xl {{ request()->routeIs('admin.events.*') ? 'bg-[#E5E5E3] text-[#444444] font-bold' : 'text-[#777777] hover:bg-[#F4F4F4] hover:text-[#555555] font-medium' }} lowercase transition">
            ...
            <a href="{{ route('admin.categories.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-2xl {{ request()->routeIs('admin.categories.*') ? 'bg-[#E5E5E3] text-[#444444] font-bold' : 'text-[#777777] hover:bg-[#F4F4F4] hover:text-[#555555] font-medium' }} lowercase transition">
