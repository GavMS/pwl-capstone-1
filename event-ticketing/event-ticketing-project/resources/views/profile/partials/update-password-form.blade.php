<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_current_password" :value="__('Current Password')" class="text-[#555555] font-medium ml-1" />
        ...
        <div>
            <x-input-label for="update_password_password" :value="__('New Password')" class="text-[#555555] font-medium ml-1" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Confirm Password')" class="text-[#555555] font-medium ml-1" />
