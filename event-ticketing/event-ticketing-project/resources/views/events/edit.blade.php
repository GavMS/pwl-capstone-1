    ...
    <div class="min-h-screen bg-[#E5E5E3] font-sans antialiased pb-24">
        ...
        <main class="max-w-4xl mx-auto px-6 lg:px-8 mt-12">
            <div class="bg-white rounded-[2.5rem] shadow-sm p-10 border border-gray-100">
                <form id="edit-event-form" action="{{ route($prefix . '.events.update', $event->id_event) }}"
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex flex-col gap-2"
                            x-data="{ desc: @js(old('description', $event->description)), max: 5000 }">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-gray-50 pt-10">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <select name="city" id="city" required
                                ...
                                @foreach(['Jakarta', 'Bandung', 'Bali', 'Surabaya', 'Yogyakarta', 'Tangerang', 'Bekasi', 'Semarang', 'Medan', 'Solo'] as $c)
                                    <option value="{{ $c }}" {{ old('city', $event->city) == $c ? 'selected' : '' }}>{{ $c }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <select name="format" id="format" required
                                class="w-full px-6 py-4 bg-[#F4F4F4] border-none rounded-2xl font-bold text-[#444444] focus:ring-2 focus:ring-[#555555] shadow-inner">
                                <option value="onsite" {{ old('format', $event->format) == 'onsite' ? 'selected' : '' }}>
                                    Event Onsite</option>
                                <option value="online" {{ old('format', $event->format) == 'online' ? 'selected' : '' }}>
                                    Event Online</option>
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-gray-50 pt-10">
                        <div class="flex flex-col gap-2">
                            ...
                            <p class="text-[9px] text-[#999999] font-bold mt-1 uppercase tracking-wider ml-1">leave
                        ...
                        <div class="flex flex-col gap-2">
                            <label for="status"
                                class="text-[10px] font-extrabold text-[#777777] uppercase tracking-widest ml-1">Status</label>
                        ...
                        <div class="flex items-center justify-between mb-6 ml-1">
                            <div>
                                <h4 class="text-[10px] font-extrabold text-[#777777] uppercase tracking-widest">ticket
                                    configurations</h4>
                                <p class="text-[10px] text-[#999999] lowercase mt-1 font-medium">update what kinds of
                    ...
                    <div class="pt-8 border-t border-gray-50 flex justify-end gap-3">
                        ...
                        <button type="button" onclick="confirmEventAction('edit-event-form', 'update this event')"
